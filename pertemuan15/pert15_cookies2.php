...
echo "<h2>Klik <a href='pert15_cookies1.php'>di sini</a> untuk penciptaan cookies</h2>"; 
echo "<h2>Klik <a href='pert15_cookies3.php'>di sini</a> untuk penghapusan cookies</h2>";
